...
public class segitiga extends AppCompatActivity {
    ...
    private void hitungLuasSegitiga() {
        ...
        // Memeriksa apakah kedua bidang teks tidak kosong dan berisi angka
        ...
        textViewHasil.setText("Luas segitiga dengan alas " + alas +
                " dan tinggi " + tinggi + " adalah " + luas);
    }

    // Fungsi untuk memeriksa apakah string berisi angka
